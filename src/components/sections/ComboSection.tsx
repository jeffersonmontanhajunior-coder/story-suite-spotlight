...
const ComboSection = ({ sectionRef }: ComboSectionProps) => (
        ...
        <div className="relative z-10">
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-8">
            <div className="p-5 rounded-xl bg-muted/50 border border-border">
              ...
              <p className="font-display text-2xl font-bold text-primary">R$ 300</p>
              <p className="text-xs text-muted-foreground">pagamento único</p>
            </div>
            <div className="p-5 rounded-xl bg-muted/50 border border-border">
              <p className="text-sm text-muted-foreground mb-1">Manutenção mensal</p>
              <p className="font-display text-2xl font-bold text-primary">R$ 100</p>
